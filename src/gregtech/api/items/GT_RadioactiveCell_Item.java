...
public class GT_RadioactiveCell_Item extends GT_Generic_Item {
	...
	protected boolean outputPulseForStack(ItemStack aStack) {
		...
		return false;// (this.pulserate > 0) || (tNBT.getInteger("output") %
						// -this.pulserate == 0);
	}
	...
	protected boolean incrementPulseForStack(ItemStack aStack) {
		...
		return false;// (this.pulserate > 0) || (tNBT.getInteger("pulse") %
						// -this.pulserate == 0);
	}
	...
	public int getDamageOfStack(ItemStack stack) {
		/*
		 * NBTTagCompound nbtData = StackUtil.getOrCreateNbtData(stack);
		 * this.dura = nbtData.getInteger("advDmg"); return this.dura;
		 */
		return 0;
	}
	...
	public int getControlTagOfStack(ItemStack stack) {
		/*
		 * NBTTagCompound nbtData = StackUtil.getOrCreateNbtData(stack); return
		 * nbtData.getInteger("tag");
		 */
		return 0;
	}
	...
	public void addAdditionalToolTips(List aList, ItemStack aStack) {
		...
		// aList.add("Time left: " + (this.maxDelay -
		// getDurabilityOfStack(aStack)) + " secs");
